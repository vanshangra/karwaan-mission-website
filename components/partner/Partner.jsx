...
const PARTNER_TYPES = [
	"All",
	...Array.from(new Set(PARTNERS.map((p) => p.type))),
];
					...
					<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
						<div>
							...
							<p className="text-gray-600 max-w-3xl mt-2">
								Organisations we collaborate with to scale programs, share expertise and create
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
						{filtered.length === 0 ? (
							...
							filtered.map((p) => (
								<article
									key={p.id}
									className="bg-white rounded-2xl p-6 shadow hover:shadow-lg transition transform hover:-translate-y-1"
								>
